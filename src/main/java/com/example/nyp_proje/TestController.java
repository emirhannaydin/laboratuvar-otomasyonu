...
public class TestController implements Initializable  {
    ...
    public static ObservableList<HastaTest> veri_cek() throws SQLException {
        ...
        try {
            PreparedStatement ps = connectDB.prepareStatement("select hasta.hasta_id,hasta_adi,hasta_soyadi,cinsiyet,test_turu,birim_adi,deger from hasta,test where test.hasta_id = hasta.hasta_id and Kullanici_Adi='"+currHasta+"'");
